...
return [
    ...
    'dispatch_success_tmpl'  => env('app_path').'/common/tips/index.html',
    'dispatch_error_tmpl'    => env('app_path').'/common/tips/index.html',
    //'exception_tmpl'         => env('app_path').'/common/tips/error.html',
    ...
    'exception_handle'       => '',
    'codekey'=>'www.crossbox.com',//加密字符串key
    'isopen_auth'=>env('app.isopen_auth',true),//是否开启权限认证
    'notlog_controller'=>array('Login','AdminActionLog','Index'),//不需要记录的操作记录的控制器
