...
(function() {
    ...
    templates['main'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "basePath", {
                hash: {}
            });
        }
    ...
    templates['operation'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        function program1(depth0,data) {
            ...
            if(typeof stack1 === functionType) {
                ...
                stack1 = helperMissing.call(depth0, "notes", {
                    hash: {}
                });
            }
            if(stack1 || stack1 === 0) {
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "httpMethod", {
                hash: {}
            });
        }
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "resourceName", {
                hash: {}
            });
        }
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "nickname", {
                hash: {}
            });
        }
        buffer += escapeExpression(stack1) + "_";
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "pathJson", {
                hash: {}
            });
        }
        //接口状态颜色
        var apiColor="#aaa";
        switch(depth0.apiStatus){
            case 2:
                apiColor="#555555";
                break;
            case 3:
        ...
        buffer += escapeExpression(stack1) + "</a>\n                  </span>\n                </h3>\n      "+(depth0.updateTime?"<span class='eachRevisionInfo' _status="+depth0.apiStatus+" style='float:right;margin:5px 20px 0 0;color:"+apiColor+"'>"+(depth0.reviser?depth0.reviser:"")+" 更新于："+depth0.updateTime+"</span>":"")+"        <ul style='float:left;margin-left:20px;' class='options'>\n                    <li>\n                        <a href='#!/";
        foundHelper = helpers.resourceName;
        stack1 = foundHelper || depth0.resourceName;
        if(typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "summary", {
                hash: {}
            });
        }
        if(stack1 || stack1 === 0) {
        ...
        var fieldDesc=depth0.fieldDesc;
        var fieldTableTr='';
        if(fieldDesc){
            for(i in fieldDesc){
                var tmpFieldVar=i.split('@');
                fieldTableTr+='<tr><td>'+tmpFieldVar[0]+'</td><td>'+tmpFieldVar[1]+'</td><td>'+fieldDesc[i]+'</td></tr>';
            }
        }
        var exampleJSON=depth0.exampleJSON;
        exampleJSON=exampleJSON?JSON.stringify(exampleJSON[0], null, "\t").replace(/\n/g, "<br>"):null;
        buffer += escapeExpression(stack1) + "_content' style='display:none'>\n    "+(depth0.description?"  <h4 style='font-size:14px;'>api 说明：</h4><p style='margin-top:10px;padding:15px;background:#fff;'>"+depth0.description+"</p>       ":"")+(depth0.revisionDesc?"  <h4 style='font-size:14px;'>修订说明：</h4><p style='margin-top:10px;padding:15px;background:#fff;'>"+depth0.revisionDesc+"</p>       ":"")
        +(exampleJSON?'<h4 style="font-size:14px;margin-top:10px;">返回结果：</h4><div class="block"><pre>'+exampleJSON+'</pre></div>':"")
        +(fieldDesc?'<h4 style="font-size:14px;margin-top:10px;">字段说明：</h4><table class="prameter_table" width="100%" cellspacing="0" cellpadding="0" style="margin-top:10px;border:1px solid #ccc;"><tr><th width="30%">返回值字段</th><th width="20%">字段类型</th><th width="50%">字段说明</th></tr>'+fieldTableTr+'</table>':"");   //新增说明
        foundHelper = helpers.notes;
        stack1 = foundHelper || depth0.notes;
        stack2 = helpers['if'];
    ...
    templates['param'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        function program2(depth0,data) {
            ...
            if(typeof stack1 === functionType) {
                ...
                stack1 = helperMissing.call(depth0, "defaultValue", {
                    hash: {}
                });
            }
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "description", {
                hash: {}
            });
        }
        if(stack1 || stack1 === 0) {
    ...
    templates['param_list'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        function program9(depth0,data) {
            ...
            if(typeof stack1 === functionType) {
                ...
                stack1 = helperMissing.call(depth0, "value", {
                    hash: {}
                });
            }
            buffer += escapeExpression(stack1) + "'>";
...
(function() {
    ...
    templates['param_readonly_required'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        function program1(depth0,data) {
            ...
            var buffer = "", stack1;
            buffer += "\n        <textarea class='body-textarea'  readonly='readonly' placeholder='(必需)' name='";
            foundHelper = helpers.name;
            stack1 = foundHelper || depth0.name;
            if(typeof stack1 === functionType) {
                stack1 = stack1.call(depth0, {
...
(function() {
    ...
    templates['param_required'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        function program2(depth0,data) {
            ...
            var buffer = "", stack1;
            buffer += "\n			<textarea class='body-textarea' placeholder='(必需)' name='";
            foundHelper = helpers.name;
            stack1 = foundHelper || depth0.name;
            if(typeof stack1 === functionType) {
                stack1 = stack1.call(depth0, {
        ...
        function program7(depth0,data) {
            ...
            buffer += escapeExpression(stack1) + "' placeholder='(必需)' type='text' value='";
            foundHelper = helpers.defaultValue;
            stack1 = foundHelper || depth0.defaultValue;
            if(typeof stack1 === functionType) {
                stack1 = stack1.call(depth0, {
...
(function() {
    ...
    templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        buffer += "<div class='heading'>\n  <h2>\n        <a style='height:20px;line-height:20px;'  href='#!/";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        ...
        buffer += escapeExpression(stack1) + " <span style='font-size:16px;margin-left:10px;'>"+depth0.description+"</span>   </a>\n  </h2>\n   <ul class='options'>\n        <li>\n            <a href='#!/";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if(typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {
        ...
        buffer += escapeExpression(stack1) + "');\">展开/收起</a>\n        </li>\n        <li>\n            <a href='#' onclick=\"Docs.collapseOperationsForResource('";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if(typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {
        ...
        if(typeof stack1 === functionType) {
            ...
            stack1 = helperMissing.call(depth0, "url", {
                hash: {}
            });
        }
...
(function() {
    ...
    SwaggerUi = (function(_super) {
        ...
        SwaggerUi.prototype.load = function(func) {
            //自定义所有请求后的回调方法
            customOnLoadedMethod=func?func:customOnLoadedMethod;
        ...
        SwaggerUi.prototype.render = function() {
            ...
            if(!location.hash){
                $('.resource').each(function(i){
                    $(this).find('.options a').eq(1).trigger('click');
                });
            }
    ...
    MainView = (function(_super) {
        ...
        MainView.prototype.render = function() {
            ...
            customOnLoadedMethod?customOnLoadedMethod():null;
            return this;
        };
    ...
    OperationView = (function(_super) {
            ...
            if (error_free) {
                ...
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                    ...
                    if (param.paramType === 'body') {
                        ...
                        postParam[param.name]=bodyParam;
                    }
                }
        ...
        OperationView.prototype.showStatus = function(data) {
            ...
            try {
                ...
                response_body = "<pre>" + data.responseText + "</pre>";
            }
