...
SwaggerApi = (function() {
            ...
            if (ops) {
                ...
                for (_i = 0, _len = ops.length; _i < _len; _i++) {
                    ...
                    op = new SwaggerOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, this,o.description,
                        o.updateTime,o.reviser,o.revisionDesc,o.fieldDesc,o.exampleJSON,o.apiStatus);
    ...
    SwaggerOperation = (function() {
        ...
        resource,description,updateTime,reviser,revisionDesc,fieldDesc,exampleJSON,apiStatus) {
