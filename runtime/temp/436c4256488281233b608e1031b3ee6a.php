<?php /*a:3:{s:101:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\school\school_add.html";i:1661415190;s:95:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\layout\main.html";i:1626942442;s:104:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\school\school_footer.html";i:1630036314;}*/ ?>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <form class='dataform layui-form' enctype="multipart/form-data" method="post" id='goodsform'>
            <table class="layui-table">
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='title' id="title" placeholder="校区标题" autocomplete="off" class="layui-input title" value='' />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='address' id="address" placeholder="校区地址" autocomplete="off" class="layui-input address" value='' />
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <textarea name="guide" id='guide' placeholder="宽带办理指引" class="layui-textarea guide"></textarea>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="number" name='sortby' id="sortby" placeholder="校区排序" autocomplete="off" class="layui-input sortby" value='0' />
                        </div>
