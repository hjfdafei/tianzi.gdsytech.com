<?php /*a:2:{s:110:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\adminuser\adminuser_assign.html";i:1586428648;s:95:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\layout\main.html";i:1626942442;}*/ ?>
<html>
    <head>
        <meta charset="utf-8">
                            ...
                            <dt>
                                <div class="layui-row layui-rowlevel1" style='padding-bottom:10px;'>
                                    <div class="layui-col-md">
                                      <input type="checkbox" name="ids[]" value="<?php echo htmlentities($item['id']); ?>" lay-filter="level-1" class="checkbox-ids" lay-skin="primary" title="<?php echo htmlentities($item['rule_title']); ?>" <?php if(in_array($item['id'],$info['role_ruleid'])): ?>checked='checked' disabled="disabled" <?php else: if(in_array($item['id'],$info['ruleid'])): ?>checked='checked'<?php endif; ?> <?php endif; ?> />
                                    </div>
                                </div>
                            </dt>
                                ...
                                <dl class="rule_ul menu-son">
                                    <dt>
                                        <div class="layui-row" style='padding-bottom:10px;'>
                                            <div class="layui-col-md">
                                                <input type="checkbox" name="ids[]" value="<?php echo htmlentities($item2['id']); ?>" lay-filter="level-2" class="checkbox-ids" lay-skin="primary" title="<?php echo htmlentities($item2['rule_title']); ?>" <?php if(in_array($item2['id'],$info['role_ruleid'])): ?>checked='checked' disabled="disabled" <?php else: if(in_array($item2['id'],$info['ruleid'])): ?>checked='checked'<?php endif; ?> <?php endif; ?> />
                                            </div>
                                        </div>
                                    </dt>
                                </dl>
...
<script type="text/javascript">
    ...
    function savedata(){
        ...
        $('#goodsform').ajaxSubmit({
            url:"<?php echo url('Adminuser/adminuser_assign'); ?>",
            type:'post',
            dataType:'json',
