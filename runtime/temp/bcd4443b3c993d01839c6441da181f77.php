<?php /*a:3:{s:100:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\goods\goods_edit.html";i:1661510117;s:95:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\layout\main.html";i:1626942442;s:102:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\goods\goods_footer.html";i:1661509710;}*/ ?>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="setting_form">
        <form class='dataform layui-form' enctype="multipart/form-data" method="post" id='goodsform'>
            <table class="layui-table">
                ...
                <tr>
                    <td class='td_right'><label class="layui-form-label">选择年级<span class='musttip'>*</span></label></td>
                    <td class='td_left'>
                        <div class="layui-input-block">
                ...
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='goods_title' id="goods_title" placeholder="宽带套餐标题" autocomplete="off" class="layui-input goods_title" value='<?php echo htmlentities($info['goods_title']); ?>' />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block" style='position:relative;'>
                            ...
                            <div class='preimg_content'><?php if($info['goods_img']!=''): ?><a href='<?php echo htmlentities($info['goods_img']); ?>' target='_blank'><img class="layui-upload-img" id="preimg_view" src='<?php echo htmlentities($info['goods_img']); ?>'></a><?php else: ?><img class="layui-upload-img" id="preimg_view"><?php endif; ?></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="number" name='goods_price' id="goods_price" placeholder="宽带套餐价格" autocomplete="off" class="layui-input goods_price" value='<?php echo htmlentities($info['goods_price']); ?>' />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <textarea name="goods_content" id='goods_content' placeholder="宽带套餐详情" class="layui-textarea goods_content"><?php echo htmlentities($info['goods_content']); ?></textarea>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="radio" name="goods_status" value="1" title="是" <?php if($info['goods_status']==1): ?>checked<?php endif; ?>>
                            <input type="radio" name="goods_status" value="2" title="否" <?php if($info['goods_status']==2): ?>checked<?php endif; ?>>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="number" name='goods_sortby' id="goods_sortby" placeholder="宽带套餐排序" autocomplete="off" class="layui-input goods_sortby" value='<?php echo htmlentities($info['goods_sortby']); ?>' />
                        </div>
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                        <div class="layui-input-block">
                            <input type="hidden" name="goodsid" value='<?php echo htmlentities($info['id']); ?>' />
