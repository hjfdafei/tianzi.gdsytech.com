        ...
        <form class='dataform layui-form' enctype="multipart/form-data" method="post" id='goodsform'>
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='keyaccount' id="keyaccount" placeholder="宽带账号" autocomplete="off" class="layui-input keyaccount" value='<?php echo htmlentities($info['keyaccount']); ?>' />
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                        <div class="layui-input-block">
                            <input type="hidden" name="broadbandid" value='<?php echo htmlentities($info['id']); ?>' />
