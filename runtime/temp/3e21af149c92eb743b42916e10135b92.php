<?php /*a:3:{s:102:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\banner\banner_edit.html";i:1611891172;s:95:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\layout\main.html";i:1614850497;s:104:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\banner\banner_footer.html";i:1611823911;}*/ ?>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <form class='dataform layui-form' enctype="multipart/form-data" method="post" id='goodsform'>
            <table class="layui-table">
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <select name="position" class='position'>
                                ...
                                <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id']==$info['position']): ?>selected='selected'<?php endif; ?>><?php echo htmlentities($vo['title']); ?></option>
                ...
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='title' id="title" placeholder="banner标题" autocomplete="off" class="layui-input title" value='<?php echo htmlentities($info['title']); ?>' />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block" style='position:relative;'>
                            ...
                            <div class='preimg_content'><?php if($info['img']!=''): ?><a href="<?php echo htmlentities($info['img']); ?>" target="_blank"><img class="layui-upload-img" src="<?php echo htmlentities($info['img']); ?>" id="preimg_view"></a><?php else: ?><img class="layui-upload-img" id="preimg_view"><?php endif; ?></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="radio" name="type" class='bannertype' lay-filter="showlink" value="1" title="无跳转" <?php if($info['type']==1): ?>checked<?php endif; ?>>
                            <input type="radio" name="type" class='bannertype' lay-filter="showlink" value="2" title="小程序" <?php if($info['type']==2): ?>checked<?php endif; ?>>
                            <input type="radio" name="type" class='bannertype' lay-filter="showlink" value="3" title="网页" <?php if($info['type']==3): ?>checked<?php endif; ?>>
                        </div>
                    </td>
                </tr>
                <tr class='linkurl_tr' <?php if($info['type']==1): ?>style='display:none;'<?php else: ?>style='display:table-row;'<?php endif; ?>>
                    <td class='td_right'><label class="layui-form-label">跳转链接</label></td>
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="text" name='linkurl' id="linkurl" placeholder="跳转链接" autocomplete="off" class="layui-input linkurl" value='<?php echo htmlentities($info['linkurl']); ?>' />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="radio" name="isshow" value="1" title="是" <?php if($info['isshow']==1): ?>checked<?php endif; ?>>
                            <input type="radio" name="isshow" value="2" title="否" <?php if($info['isshow']==2): ?>checked<?php endif; ?>>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class='td_left'>
                        <div class="layui-input-block">
                            <input type="number" name='sortby' id="sortby" placeholder="banner排序" autocomplete="off" class="layui-input sortby" value='<?php echo htmlentities($info['sortby']); ?>' />
                        </div>
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                        <div class="layui-input-block">
                            <input type="hidden" name="bannerid" value='<?php echo htmlentities($info['id']); ?>' />
