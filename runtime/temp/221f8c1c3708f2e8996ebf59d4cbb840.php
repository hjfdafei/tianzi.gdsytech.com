<?php /*a:3:{s:100:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\grade\grade_list.html";i:1661507007;s:95:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\layout\main.html";i:1626942442;s:102:"E:\webenv\apache2.4.39\htdocs\tianzi.gdsytech.com\application\sytechadmin\view\grade\grade_footer.html";i:1661507231;}*/ ?>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-row">
                <div class="layui-col-md12">
                    <button class="layui-btn layui-btn" onclick="grade_add()">新增年级</button>
                    <button class="layui-btn layui-btn-danger" onclick="grade_del();">删除年级</button>
                </div>
            </div>
            <div style='height:20px;'></div>
                <form class="layui-form" enctype="multipart/form-data" method="post" id='searchform'>
                    ...
                    <div class="layui-row">
                        ...
                        <span class="layui-btn" onclick="grade_search()">搜索</span>
                        <a style="margin-left:20px;" class="layui-btn layui-btn-normal" href="<?php echo url('Banner/grade_list'); ?>">刷新</a>
                    </div>
                </form>
                <?php if(count($list)<=0): ?>
                ...
                <div class='layui-row'>
                    <table class="layui-table layui-form" id="goods_table">
                        ...
                        <tr class='table_tr'>
                            ...
                            <td>
                                <?php if($vo['isshow']==1): ?>
                                    <a class="layui-btn layui-btn-normal layui-btn-sm" onclick="grade_hide(<?php echo htmlentities($vo['id']); ?>)">隐藏</a>
                                <?php else: ?>
                                    <a class="layui-btn layui-btn-normal layui-btn-sm" onclick="grade_show(<?php echo htmlentities($vo['id']); ?>)">显示</a>
                                <?php endif; ?>
                                <a class="layui-btn layui-btn-warm layui-btn-sm" onclick="grade_edit(<?php echo htmlentities($vo['id']); ?>)">修改</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr>
